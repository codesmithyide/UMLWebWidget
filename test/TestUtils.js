...
function exportSVGToHTML(svg, path, stylesheet = false) {
    let data = ""
    if (stylesheet) {
        data = "<!DOCTYPE html><html><head><link rel=\"stylesheet\" href=\"../../../StyleSheets/CodeSmithyUMLWebWidget.css\"></link></head><body><div class=\"CodeSmithyUMLWebWidget\">" + svg.svg() + "</div></body></html>"
    } else {
